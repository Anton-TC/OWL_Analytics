  ...
  constructor(config) {
    ...
    this.restClientInstance = async (request, init = {}) => {
      ...
      if (response.status === 401) {
        ...
        throw new import_errors.NotFoundError({
          error: response.statusText || import_errors.CustomErrorMsg.NOT_FOUND,
          ...errorObject
        });
      }
    ...
    if (!this.restClientInstance.fetch) {
      throw new import_errors.CustomError({ error: import_errors.CustomErrorMsg.MISSING_FETCH });
    }
  }
}
