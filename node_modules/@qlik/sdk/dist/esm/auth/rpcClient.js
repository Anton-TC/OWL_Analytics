...
var NotFoundError = class extends GenericError {
};
var EngineCloseError = class extends GenericError {
...
var EngineMessageError = class extends GenericError {
...
var RestClient = class {
  constructor(config) {
    ...
    this.restClientInstance = async (request, init = {}) => {
      ...
      const initUpdatedHeaders = {
        ...
        headers: {
          ...
          "User-Agent": `qlik-sdk-typescript/${version} (${osName})`,
          ...headers
        }
      };
      let response;
      ...
      if (response.status === 401) {
        ...
        throw new NotFoundError({
          error: response.statusText || "Requested resource not found or lacking access permissions" /* NOT_FOUND */,
          ...errorObject
        });
      }
    ...
    if (!this.restClientInstance.fetch) {
      throw new CustomError({ error: "Missing fetch function" /* MISSING_FETCH */ });
    }
  }
};
